function stepLine(stepNum, stepGoal) {	
	...
	num = (num > 100) ? 100 : num;
	//	$('.showDiv').animate({width:num+'%'},800,'ease-out')
	...
	//	            if(index !== stepNum){
	//	                index = stepNum;
	//	                var string_num = index.toString();
	//	                if(string_num>3){
	//	                    var string_num = formatNumber(string_num)	
	//	                }
	//	                $(".stepNum").html(string_num)
	//	            }
	//	        },800)
	//	    }					
	//	},30);
			...
			if(path == 'globalStepRank') {
				...
				$('.global_rank .list_heartWrap').each(function(item, el) {
					$(this).on('tap', function(e) {
						e.stopPropagation();
						console.log(item)
						var id = 'b6ac1657cb1d4c76bac97ecff5494fa4';
						var _this = $(this);
