...
@interface XImageClipViewController ()
...
@implementation XImageClipViewController
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(XImageClipDelegate)]) {
